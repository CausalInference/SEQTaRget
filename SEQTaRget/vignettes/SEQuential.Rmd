...
3. `eligible` and column names provided to `excused.cols` are binary (0/1) flag variables (with respect to `time.col`)
...
We provide some print statements to help track where the `SEQuential()` function is processing at any given point in time.
...
```{r outcome, fig.alt="Survival curve by treatment group."}
