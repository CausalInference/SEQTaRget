...
| `end_of_fup.window` | Half-width of the window used when a trial-period has no measurement at exactly `end_of_fup.time`; it then falls back to the measurement nearest to `k` within `[k - window, k + window]` (ties broken toward the earlier one), and is censored if there is none | Numeric | `3` |
