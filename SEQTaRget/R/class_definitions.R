...
setClass("SEQopts",
  slots = c(
    ...
    risk.times = "numeric",
    end_of_fup = "logical",
    end_of_fup.time = "numeric",
    end_of_fup.type = "character",
    end_of_fup.window = "numeric",
    ...
    weight.stabilized = "logical",
    weight.spline = "logical",
    weight.spline.df = "integer",
    excused = "logical",
    hazard = "logical",
    ...
    glm.package = "character",
    parglm.control = "ANY",
    multinomial = "logical",
    treat.level = "list",
    followup.class = "logical",
    followup.spline = "logical",
    followup.spline.df = "integer",
