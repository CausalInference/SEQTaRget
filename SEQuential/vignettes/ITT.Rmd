...
options <- SEQopts(# tells SEQuential to create kaplan meier curves
                   ...
                   bootstrap = TRUE,
                   # tells SEQuential to run bootstraps 10 times
                   bootstrap.nboot = 10)
...
## ITT with 10 bootstrap samples and losses-to-followup
...
## ITT with 10 bootstrap samples and competing events
...
## ITT hazard ratio with 10 bootstrap samples and competing events
```{r eval=FALSE}
...
## ITT with 10 bootstrap samples and competing events in subgroups defined by sex
```{r, eval=FALSE}
options <- SEQopts(km.curves = TRUE,               
                   bootstrap = TRUE,                
                   bootstrap.nboot = 10,     
