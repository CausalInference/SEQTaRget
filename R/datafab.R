...
#myparams <- SEQopts(covariates = "tx_init_bas+sex+period+L_bas+N_bas+P_bas")
#data <- gen_data()
#test.expand <- SEQuential::SEQexpand(data, "ID", "time", "eligible", "outcome", myparams)
...
#opts$covariates = "tx_init_bas+sex+period+L_bas+N_bas+P_bas"
#autoplot(test$surv)
